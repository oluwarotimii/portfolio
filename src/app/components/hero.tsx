...
export default function Hero() {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gray-900 text-white overflow-hidden px-4">
      <div className="container mx-auto">
        ...
        >
          <motion.h2 
            className="text-sm md:text-base uppercase tracking-wider mb-2 text-amber-400"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <motion.a 
              href="#contact" 
              className="inline-flex items-center bg-amber-600 text-white px-6 py-3 rounded-full hover:bg-amber-700 transition-colors text-base md:text-lg font-semibold"
