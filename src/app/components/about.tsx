      ...
      <div className="container mx-auto px-4 flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-between w-full">
          ...
          >
            ...
            <p className="text-base md:text-lg mb-4 text-gray-300">
              My journey in development began with a fascination for how design and technology intersect to create seamless user experiences. This passion has driven me to continuously learn and adapt to the ever-evolving world of frontend and mobile app development.
            </p>
